...
/**
 * = TodoesCollectionThymeleafLinkFactory
 TODO
 *
 */
@Component
public class TodoesCollectionThymeleafLinkFactory implements MethodLinkFactory<TodoesCollectionThymeleafController> {
    /**
     * TODO
     *
     */
     ...
     * @return Class
     */
    public Class<TodoesCollectionThymeleafController> getControllerClass() {
        return TodoesCollectionThymeleafController.class;
    }
}
