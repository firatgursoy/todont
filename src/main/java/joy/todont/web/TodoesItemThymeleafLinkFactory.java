...
/**
 * = TodoesItemThymeleafLinkFactory
 TODO
 *
 */
@Component
public class TodoesItemThymeleafLinkFactory implements MethodLinkFactory<TodoesItemThymeleafController> {
    /**
     * TODO
     *
     */
     ...
     * @return Class
     */
    public Class<TodoesItemThymeleafController> getControllerClass() {
        return TodoesItemThymeleafController.class;
    }
