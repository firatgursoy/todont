...
/**
 * = TopicsItemThymeleafControllerIT
 TODO Auto-generated class documentation
 *
 */
@SpringletsWebMvcTest(controllers = TopicsItemThymeleafController.class, secure = true)
@RunWith(SpringRunner.class)
@WithMockUser
public class TopicsItemThymeleafControllerIT {
    /**
