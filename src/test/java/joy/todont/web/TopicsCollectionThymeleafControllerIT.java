...
/**
 * = TopicsCollectionThymeleafControllerIT
 TODO Auto-generated class documentation
 *
 */
@SpringletsWebMvcTest(controllers = TopicsCollectionThymeleafController.class, secure = true)
@RunWith(SpringRunner.class)
@WithMockUser
public class TopicsCollectionThymeleafControllerIT {
    /**
